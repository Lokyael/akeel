...
| [mattpocock/skills](https://github.com/mattpocock/skills) | adapted | TDD 辅助文档、code review、`bug-reproduction`、domain modeling、module design、grilling、implementation、handoff、spec/ticket 等技能的流程基础 | MIT；Copyright (c) 2026 Matt Pocock；原始 revision 未固定 |
| [danielvm-git/bigpowers](https://github.com/danielvm-git/bigpowers) | adapted | security review、change preflight、fix validation、`systematic-debugging` 的 Bug Task 入口、survey context，以及部分 planning 和 document grilling 流程 | MIT；Copyright (c) 2026 Daniel VM；原始 revision 未固定 |
