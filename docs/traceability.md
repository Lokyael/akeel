...
| [obra/superpowers](https://github.com/obra/superpowers) | adapted | `src/bootstrap/principles.md` 的 Verify Before Claiming；TDD、`systematic-debugging`、`implementation-planning`、brainstorming 等技能的流程基础 | MIT；Copyright (c) 2025 Jesse Vincent；原始 revision 未固定 |
...
| John Ousterhout, *A Philosophy of Software Design* | conceptual reference | `skills/disciplines/module-design/SKILL.md` 中的 deep module 等设计词汇 | 受版权保护的出版物；仅记录概念影响，不复制书籍正文 |
