...
| 7 | 安全扩展模块化拆分 | 代码架构 | [ADR-007](./007-security-gate-modular-split.md) |
...
| 11 | 统一命令分类体系（taxonomy 模块） | 代码架构 | [ADR-011](./011-unified-command-taxonomy.md) |
| 12 | Pipeline 拆解与 Bootstrap 简化 | 代码架构 | [ADR-012](./012-pipeline-bootstrap-simplify.md) |
| 13 | 原则向用户项目的统一部署 | 文档架构 | [ADR-013](./013-unified-principles-deployment.md) |
| 16 | 安全门控模块边界与统一命名 | 代码架构 | [ADR-016](./016-module-boundaries-and-naming.md) |
