---
name: evidence-first
description: Evidence before assertions — requires running verification commands and confirming output before any success claims. Use when about to claim work is complete, fixed, or passing.
---
