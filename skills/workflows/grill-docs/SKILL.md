...
argument-hint: "What should I grill you about (with docs)?"
---

Run a `/grill-plan` session, using the `/domain-modeling` skill to capture decisions as ADRs and glossary entries in real time.
