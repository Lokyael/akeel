...
// 两者共用同一名单与 skip 计数，防止新增 wrapper 时解析与解包不同步。

// WRAPPER_CMDS 仅内部构造 SET，无外部消费者（先例 STDIN_EXECUTORS，5b395af）。
const WRAPPER_CMDS = ["env", "command", "nohup", "exec", "timeout"] as const;
