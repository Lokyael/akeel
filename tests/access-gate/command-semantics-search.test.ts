...
defineAdapterTests("search", [
  ...
  { cmd: "find . -name '*.log' -exec rm {} \\;", name: "find -exec upgrades to modify", cls: "modify", intents: [{ operation: "search", rawPath: "." }, { operation: "search", rawPath: "{}" }, { operation: "search", rawPath: "\\" }] },
  { cmd: "find . -name '*.js' -execdir rm {} +", name: "find -execdir upgrades to modify", cls: "modify", intents: [{ operation: "search", rawPath: "." }, { operation: "search", rawPath: "{}" }, { operation: "search", rawPath: "+" }] },
  { cmd: "find . -ok rm {} \\;", name: "find -ok upgrades to modify", cls: "modify", intents: [{ operation: "search", rawPath: "." }, { operation: "search", rawPath: "{}" }, { operation: "search", rawPath: "\\" }] },
