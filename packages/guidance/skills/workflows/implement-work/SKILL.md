...
5. When the surface remains unchanged and all blocking findings are resolved, commit the final landing change with durable updates and the Task clear operation. Leave the final landing surface Task-free and preserve the only reachable checkpoint commit.
