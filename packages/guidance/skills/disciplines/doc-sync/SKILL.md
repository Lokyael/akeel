...
7. **Task lifecycle**: Task Record status matches reality; active tasks remain `draft` or `in-progress`, and completion clears the Task atomically with durable updates.
