...
const DENY_REASONS: Readonly<Record<HostFacingBlockCode, string>> = Object.freeze({
  ...
  "hard-boundary": "Blocked by a security boundary. Do not attempt bypasses or script wrappers; halt and report to the user.",
  "path-denied": "Blocked by path policy.",
  "invalid-admission": "Blocked because the authorization facts are invalid.",
  "security-boundary": "Blocked by a security boundary. Do not attempt bypasses or script wrappers; halt and report to the user.",
